<?php $__env->startSection('title', '현장 상세 | GADA Admin'); ?>
<?php $__env->startSection('page-title', '현장 상세'); ?>
...
<div class="flex items-center justify-between mb-4">
  ...
  <div class="flex items-center gap-2">
    ...
    ?>
    <span class="px-2.5 py-1 rounded-full text-xs font-semibold border <?php echo e($sc); ?>">
...
<div class="bg-white rounded-lg border border-gray-200 p-5 mb-4">
  <h2 class="text-lg font-bold text-gray-900"><?php echo e($site->name); ?></h2>
  <p class="text-sm text-gray-500 mt-0.5"><?php echo e($site->address); ?></p>
  <div class="flex items-center gap-3 mt-2 flex-wrap text-xs text-gray-400">
    <?php if($site->province): ?>
      <span>📍 <?php echo e($site->province); ?></span>
    <?php endif; ?>
    <?php if(isset($site->district)): ?>
      <span>· <?php echo e($site->district); ?></span>
    <?php endif; ?>
    <?php if(isset($site->site_type)): ?>
      <span class="bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded"><?php echo e($site->site_type); ?></span>
    <?php endif; ?>
    <span>· 생성: <?php echo e(\Carbon\Carbon::parse($site->created_at)->format('Y-m-d')); ?></span>
  </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
  ...
  <div class="bg-white rounded-lg border border-gray-200 p-5">
    ...
    <dl class="space-y-2.5">
      <div class="flex gap-3">
        ...
        <dd class="text-xs text-gray-700 font-medium"><?php echo e($site->manager_name); ?></dd>
      </div>
      <?php if($site->company_name): ?>
      <div class="flex gap-3">
        <dt class="text-xs text-gray-400 w-20 shrink-0">회사명</dt>
        <dd class="text-xs text-gray-700"><?php echo e($site->company_name); ?></dd>
      </div>
      <?php endif; ?>
    </dl>
  </div>
  ...
  <div class="bg-white rounded-lg border border-gray-200 p-5">
    ...
    <dl class="space-y-2.5">
      <?php if(isset($site->lat) && $site->lat): ?>
      <div class="flex gap-3">
        <dt class="text-xs text-gray-400 w-20 shrink-0">위도</dt>
        <dd class="text-xs text-gray-700 font-mono"><?php echo e($site->lat); ?></dd>
      </div>
      <div class="flex gap-3">
        <dt class="text-xs text-gray-400 w-20 shrink-0">경도</dt>
        <dd class="text-xs text-gray-700 font-mono"><?php echo e($site->lng); ?></dd>
      </div>
      <div class="mt-2">
        <a href="https://maps.google.com/?q=<?php echo e($site->lat); ?>,<?php echo e($site->lng); ?>" target="_blank" rel="noopener"
  ...
  <div class="bg-white rounded-lg border border-gray-200 p-5">
    ...
    <div class="space-y-2">
      <div class="flex justify-between text-xs">
        ...
        <span class="font-semibold text-blue-600"><?php echo e($openCount); ?></span>
      </div>
      <div class="flex justify-between text-xs">
        <span class="text-gray-400">마감</span>
        <span class="font-semibold text-gray-700"><?php echo e($filledCount); ?></span>
      </div>
      <div class="flex justify-between text-xs">
        <span class="text-gray-400">완료</span>
        <span class="font-semibold text-green-600"><?php echo e($completedCount); ?></span>
      </div>
      <div class="flex justify-between text-xs">
        <span class="text-gray-400">취소</span>
        <span class="text-gray-400"><?php echo e($cancelledCount); ?></span>
      </div>
      <div class="flex justify-between text-xs border-t border-gray-100 pt-2 mt-2">
        <span class="text-gray-500 font-medium">전체</span>
        <span class="font-bold text-gray-900"><?php echo e($jobs->count()); ?></span>
      </div>
    </div>
  </div>
</div>
      ...
      <tbody class="divide-y divide-gray-50">
        ...
        <tr class="hover:bg-gray-50">
          <td class="px-4 py-2.5">
            <a href="/admin/jobs/<?php echo e($job->id); ?>" class="font-medium text-gray-900 hover:text-blue-600 transition-colors truncate block max-w-[160px]">
              <?php echo e($job->title); ?>

            </a>
          </td>
          <td class="px-4 py-2.5 text-gray-500"><?php echo e($job->trade_name ?? '—'); ?></td>
          <td class="px-4 py-2.5 text-gray-500"><?php echo e($job->work_date ? \Carbon\Carbon::parse($job->work_date)->format('Y-m-d') : '—'); ?></td>
          ...
          <td class="px-4 py-2.5 text-right">
            <a href="/admin/jobs/<?php echo e($job->id); ?>" class="text-blue-600 hover:text-blue-800 font-medium px-2 py-0.5 rounded hover:bg-blue-50 transition-colors">
              보기
            </a>
          </td>
        </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/leewonyuep/gada-vn/apps/admin-laravel/resources/views/admin/sites/show.blade.php ENDPATH**/ ?>
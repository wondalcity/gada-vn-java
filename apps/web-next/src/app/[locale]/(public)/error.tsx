...
export default function PublicError({
  ...
  return (
    <div className="min-h-dvh flex flex-col items-center justify-center bg-[#e5e7eb] px-6 text-center">
      <div className="w-16 h-16 rounded-full bg-[#FDE8EE] flex items-center justify-center mb-4">
        <svg className="w-8 h-8 text-[#ED1C24]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
